...
export default class example extends Component {
    ...
    get example1 () {
        ...
        return (
            <View style={styles.exampleContainer}>
                <Text style={styles.title}>CONTOH 1</Text>
                <Text style={styles.subtitle}>
                    INI PAKAI LOOPING DENGAN INDIKATOR DOT ATAU TITIK
                </Text>
                <Carousel
    ...
    get example2 () {
        return (
            <View style={styles.exampleContainer}>
                <Text style={styles.title}>CONTOH 2</Text>
                <Text style={styles.subtitle}>INI PAKI SWIPE KANAN - KIRI</Text>
                <Carousel
                  data={ENTRIES2}
